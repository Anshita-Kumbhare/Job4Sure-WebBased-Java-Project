...
<html>
    ...
    <body>
        ...
        <img src="images/jobstatus.jpg" style="height:500px; width:500px; margin-left:50px; margin-top:50px;">
        
        <div>
        <form action="updatejoblogic.jsp">
        <br><br>
        
        <table  cellspacing="10" cellpadding="10" align="center" border="0" class="registrationformtheme">
            <tr align="center">
                <td colspan="4"><h2>Update the job status</h2></td>
            </tr>
            <tr>
                <td>Job Id</td>
            ...
            <tr>
                <td>Job Status</td>
                <td><select name="jstatus" class="texttheme">
            ...
            <tr align="center">
                    <td colspan="4">
                        <input type="submit" name="submit" value="SUBMIT" style="border: outset">
                    </td>
                </tr>
        </table>
        </form>
